...
const Necklaces = () => {
  return (
   ...
   <div className="px-10 py-8">
      <h2 className="text-sm text-gray-500 mb-2">Home / Necklaces</h2>
      <h1 className="text-5xl font-serif mb-4">NECKLACES</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
        <div className="text-center">
          <div className="overflow-hidden">
              <a className="" href="/Productdetail10">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-01-a.jpg"
              alt="Product Name 19"
        ...
        <div className="text-center">
          <div className="overflow-hidden">
              <a className="" href="/Productdetail11">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-02-a.jpg"
              alt="Product Name 20"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
            </a>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-03-a.jpg"
              alt="Product Name 21"
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-04-a.jpg"
              alt="Product Name 22"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-05-a.jpg"
              alt="Product Name 23"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/necklace-06-a.jpg"
              alt="Product Name 24"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
