...
const Bracelets = () => {
  return (
   ...
   <div className="px-10 py-8">
      <h2 className="text-sm text-gray-500 mb-2">Home / Bracelets</h2>
      <h1 className="text-5xl font-serif mb-4">BRACELETS</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
        <div className="text-center">
          <div className="overflow-hidden">
            <a className="" href="/Productdetail6">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-01-a.jpg"
              alt="Product Name 19"
        ...
        <div className="text-center">
          <div className="overflow-hidden">
              <a className="" href="/Productdetail7">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-02-a.jpg"
              alt="Product Name 20"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
            </a>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-03-a.jpg"
              alt="Product Name 21"
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-04-a.jpg"
              alt="Product Name 22"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-05-a.jpg"
              alt="Product Name 23"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
        ...
        <div className="text-center">
          <div className="overflow-hidden">
            <img
              src="https://websitedemos.net/blingg-jewelry-store-04/wp-content/uploads/sites/1119/2022/08/bracelet-06-a.jpg"
              alt="Product Name 24"
              className="mx-auto transition-transform duration-300 transform hover:scale-110"
            />
          </div>
